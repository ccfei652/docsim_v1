...
class NoUnknownDocumentProcessor:
...
class NoUnknownSimilarityAnalyzer:
...
if __name__ == "__main__":
    ...
    # processor = NoUnknownDocumentProcessor(model=word2vec_model, nlp=nlp)
    # analyzer = NoUnknownSimilarityAnalyzer(df=df, processor=processor)
    #
    # # Aplicar vetorização
